                    ...
                    case "followers":
                        {
                            ...
                            foreach (var folower in userFollowings)
                            {
                                profiles.Add(await _profileReader.ReadProfile(folower.Observer.UserName));
                            }
                            break;
                        }
                    case "following":
                        {
                            ...
                            foreach (var folower in userFollowings)
                            {
                                profiles.Add(await _profileReader.ReadProfile(folower.Target.UserName));
                            }
                            break;
                        }
